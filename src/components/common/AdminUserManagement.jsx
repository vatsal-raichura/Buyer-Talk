...
import { toast, ToastContainer, Bounce } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import "../../assets/admin.css"; // Keep your custom styles
      ...
      <Container>
        ...
        {loading ? (
          ...
          <Row xs={1} sm={2} md={3} lg={4} className="g-4">
            {users.map((user) => (
              <Col key={user._id}>
                <Card className="user-card h-100 shadow user-card-hover">
                  <Card.Body className="d-flex flex-column justify-content-between">
                    <div className="w-100 mb-2">
                      <Card.Title className="text-primary fs-6 mb-1">
                        {user.firstname} {user.lastname}
                      </Card.Title>
                      </div>
                      <div className="mt-1">
                    ...
                    <div className="d-flex justify-content-between mt-auto pt-3 w-100">
                      <Button
